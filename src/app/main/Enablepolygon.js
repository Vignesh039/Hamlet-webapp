...
.controller('Enablepolygon', function modalController ($scope,$http, $modalInstance,localStorageService,ZIPPR_ENVIRONMENT,Messages) {
    'use strict';
     ...
     $scope.userConfirmation = function(str)
      ...
      var req1 = {
            method: 'POST',
            url: ZIPPR_ENVIRONMENT.server+"hamlet/nadmin/neighbourhoods/enable",
